...
// Открыть страницу линкдин со скилами, прокрутить вниз страницым до конца, ЧТОБЫ ВСЕ СКИЛЫ ПРОГРУЗИЛИСЬ, открыть DexTools (клавиша F12, или Command (⌘) + Option (⌥) + J) и вкладку Console.
...
// Ауф, я подвердил твои скилы через кнопку "Endordse", если будет время, подтверди и мои. Буду премного длагодарен. Если лень нажимать, вот скрипт для автоматизации данного процесса.