...
// Открыть страницу линкдин со скилами, прокрутить вниз страницы до конца, ЧТОБЫ ВСЕ СКИЛЫ ПРОГРУЗИЛИСЬ, открыть DexTools (клавиша F12, или Command (⌘) + Option (⌥) + J) и вкладку Console.
